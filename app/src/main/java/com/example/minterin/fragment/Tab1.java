...
import com.example.minterin.adapter.MatkulAdapter;
import com.example.minterin.helperS.ApiOnly;
...
public class Tab1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rcView = view.findViewById(R.id.rc_matkul);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<List<Matkul>> result = apiOnly.getMatkul();
        result.enqueue(new Callback<List<Matkul>>() {
            @Override
            public void onResponse(Call<List<Matkul>> call, Response<List<Matkul>> response) {
                listMatkul = response.body();
                adapterM = new MatkulAdapter(getActivity(), listMatkul);
